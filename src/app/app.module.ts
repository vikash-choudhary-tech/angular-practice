...
@NgModule({
    declarations : [AppComponent,ReactiveFormsComponent,ClickableDirective,Employees,EmployeeDetail, AgePipe, NamePipe, AppTest, PlaceholderDirective, DynamicComponentLoaderComponent, TestComponentComponent],
